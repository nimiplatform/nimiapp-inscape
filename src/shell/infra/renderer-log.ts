...
type InscapeRendererLogPayload = {
  level: InscapeRendererLogLevel;
  area: string;
  message: string;
  traceId?: string;
  flowId?: string;
...
export function logRendererEvent(payload: InscapeRendererLogPayload): void {
  const sanitized: InscapeRendererLogPayload = {
    ...payload,
