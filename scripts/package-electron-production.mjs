...
try {
  ...
  await rebuild({ buildPath: productionSourceRoot, electronVersion: electronPackage.version, arch: NATIVE_ARCH, onlyModules: ['better-sqlite3'], force: true });
  ...
  const packagePaths = await packager({
    ...
    arch: NATIVE_ARCH,
    appBundleId: "ai.nimi.apps.nimi.inscape",
